...
public class PasswordField extends JPasswordField {
    ...
    private String labelText = "Texto";
    ...
    public PasswordField() {
        ...
        setCaretColor(new Color(102, 102, 255));
        ...
        eye = new ImageIcon(getClass().getResource("/resource/eye.png")).getImage().getScaledInstance(20, 20, Image.SCALE_SMOOTH);
        eye_hide = new ImageIcon(getClass().getResource("/resource/eye_hide.png")).getImage().getScaledInstance(20, 20, Image.SCALE_SMOOTH);
