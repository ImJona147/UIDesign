...
import com.imjona.ui.drawer.scroll.ScrollBar;
...
public class Drawer implements DrawerController {
    ...
    private Color drawerBackground = new Color(0, 170, 182);
    ...
    public Drawer addChild(boolean isVisible, Component... component) {
        if (isVisible) {
            for (Component com : component) {
                if (com instanceof DrawerItem) {
                    DrawerItem item = (DrawerItem) com;
